...
const drop = () => {
  ...
  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(eventName => {
    fileInputs.forEach(input => {
      input.addEventListener(eventName, evntPreventDefault, false);
    });
  });
  function evntPreventDefault(e) {
    e.evntPreventDefault;
    e.stopPropagation();
  }
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_drop__WEBPACK_IMPORTED_MODULE_12__["default"])(); // поддержка перетаскивания файла.
});
/******/ })()
;
